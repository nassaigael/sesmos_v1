...
import { X, Building2, User, Mail, Phone, MapPin, FileText, CreditCard, Edit, Clock, CheckCircle, XCircle, UserPlus, Key } from 'lucide-react';
                            ...
                            <div className="flex-1 text-center md:text-left">
                                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {existingUser && (
                                            <div className="flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-medium" style={{ backgroundColor: `${COLORS.accent}20`, color: COLORS.accent }}>
